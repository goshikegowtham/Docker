...
# Prepare the results
result = (
    f"Word count in the IF.txt file: {word_count1}\n"
    f"Word count in the AlwaysRememberUsThisWay.txt file: {word_count2}\n"
    f"Grand total word count: {grand_total_words}\n\n"
    f"Top 3 words in  the IF.txt file: {top_words_file1}\n"
    f"Top 3 words in AlwaysRememberUsThisWay.txt: {top_words_file2}\n\n"
    f"Container IP Address is : {ip_address}\n"
)
